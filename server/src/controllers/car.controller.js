...
const updateCar = asyncHandler(async (req, res) => {
    ...
    if (batteryCapacityKwh !== undefined)
        car.battery_capacity_kwh = batteryCapacityKwh;
    if (maxChargingPowerKw !== undefined)
        car.max_charging_power_kw = maxChargingPowerKw;
...
export { postCar, listMyCars, getCarById, updateCar, deleteCar };
