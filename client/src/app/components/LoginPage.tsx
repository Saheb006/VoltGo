...
import { User, Mail, Lock, Zap, Car, Battery } from 'lucide-react';
        ...
        <div className="w-full max-w-sm">
          ...
          {error && (
            <div className={`mb-4 p-3 rounded-lg text-sm ${
              isDarkMode ? 'bg-red-900/50 text-red-300 border border-red-700' : 'bg-red-50 text-red-600 border border-red-200'
            }`}>
              {error}
            </div>
          )}
